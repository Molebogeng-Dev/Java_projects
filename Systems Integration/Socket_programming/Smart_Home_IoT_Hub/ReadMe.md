...
1. 1.DeviceCommand.java (The Blueprint)
2. 2.MobileAppClient.java (The Phone / Client)
3. 3.SmartHubServer.java (The Central Hub / Switchboard)
4. 4.HubWorkerThread.java (The specific worker handling one device's request)

**Step-by-Step Requirements**

1. **DeviceCommand.java**
...
2. **MobileAppClient.java**

* Create a new DeviceCommand object (e.g., set the "BedroomAC" to "SET_TEMP" at 68).
...
* When a connection is accepted, create a new HubWorkerThread object, pass the connected socket to it, put it in a new Thread, and .start() it.

4. **HubWorkerThread.java**

* Make sure this class implements Runnable.
* It needs a constructor that accepts a Socket passed from the SmartHubServer.
